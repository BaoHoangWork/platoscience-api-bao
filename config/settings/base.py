"""
Django settings for plato_api project.
...
SIMPLE_JWT = {
    ...
    'AUTH_COOKIE_SECURE': True,    # Use secure cookies (HTTPS only)
...
MIDDLEWARE = [
    ...
    'config.middleware.token_refresh_middleware.TokenRefreshMiddleware'
]
